...
L2_wb = openpyxl.load_workbook("/Users/jonathanturck/Documents/C23-52_v2/taxfin_inputs/level-2-R.xlsx")
...
for row_index, row in enumerate(combined_sheet.iter_rows(values_only=True)):
    if all(val in row for val in [' ', 'mean', 'mean', 'mean', 'mean', 'mean', 'mean', 'median', 'median', 'median', 'median', 'median', 'median', 'count', 'count', 'count', 'count', 'count', 'count', 'min', 'min', 'min', 'min', 'min', 'min', 'max', 'max', 'max', 'max', 'max', 'max', 'sd', 'sd', 'sd', 'sd', 'sd', 'sd']):
...
output_combined_csv = 'C23-52/L2/L2_combined_summ_stats.csv'
...
with open ('C23-52/L2/L2_combined_summ_stats.csv', 'r', newline='') as csvfile:
...
with open("/Users/jonathanturck/Documents/C23-52_v2/taxfin_inputs/L2_phylum.csv", newline="") as L2_phylum_ABC:
...
with open("C23-52/L2/L2_common_taxons.txt", 'w') as file:
